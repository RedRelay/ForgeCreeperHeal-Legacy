...
public class SerializableTimeline extends TickTimeline<ISerializableHealable> implements INBTSerializable<NBTTagCompound>{
	...
	public NBTTagCompound serializeNBT() {
		...
		for(final Node<Collection<ISerializableHealable>> node : this.getTimeline()){
